...
class AdminStocksCategoryController extends BaseController
{
    ...
    {
        $query = AdminStocksCategory::find();
    ...
    public function actionUpdate()
    {
        if(Yii::$app->request->isAjax){
            ...
            $res = AdminStocksCategory::updateAll($attributes,$condition);
            if($res || $res === 0){
    ...
    public function actionDelrecord()
    {
        if(Yii::$app->request->isAjax){
            ...
            $res = AdminStocksCategory::deleteAll(['in','id',$ids]);
            if($res){
