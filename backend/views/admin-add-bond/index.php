                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group" style="margin: 5px;">
                                    <label><?= $modelLabel->getAttributeLabel("order_id") ?>：</label>
                                    <input type="text" class="form-control" id="query[order_id]" name="query[order_id]" value="<?= isset($query["order_id"]) ? $query["order_id"] : "" ?>">
                                </div>
                                <div class="form-group" style="margin: 5px;">
                                    <label><?= $modelLabel->getAttributeLabel("user_id") ?>：</label>
                                    <select name="query[user_id]" class="form-control">
                                        <?php
                                        foreach ( $user  as $k=> $val ) {
                                            echo " <option value='$k'". ($k==$query['user_id']?'selected':'').">$val</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                                <div class="form-group" style="margin: 5px;">
                                    <label><?= $modelLabel->getAttributeLabel("created_time") ?>：</label>
                            ...
                            <div class="col-sm-12">
                                ...
                                <table id="data_table" class="table table-bordered table-striped dataTable" role="grid"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                            aria-sort="ascending"><?= $modelLabel->getAttributeLabel("deposit_amout") ?></th>
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                            aria-sort="ascending"><?= $modelLabel->getAttributeLabel("description") ?></th>
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                    ...
                                    foreach ($model as $list) {
                                        ...
                                        <tr id="rowid_$list->id">
                                            ...
                                            <td><?= $list->order['order_sn'] ?></td>
                                            <td><?= $list->deposit_amout ?></td>
                                            <td><?= $list->description ?></td>
                                            <td><?= date('Y-m-d H:i',$list->created_time) ?></td>
                                            <td><?= $list->status?'通过':'申请' ?></td>
                                            <td class="center">
