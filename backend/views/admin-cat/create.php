                ...
                <div class="box-header">
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <a id="create_btn" href="<?=Url::toRoute([$this->context->id.'/index'])?>" class="btn btn-xs btn-primary"><?=$test?></a>
                        </div>
                    </div>
                </div>
                <!-- /.box-header -->
                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-sm-2">
                              <select name="AdminCat[pid]" id="" class="form-control">
                                  <option <?=($pid==0) ? 'selected' : '';?> value="0">添加顶级分类</option>
                                  <?php foreach($tree as $v):?>
                                      <option <?=($pid==$v->id) ? 'selected' : '';?> value="<?=$v->id?>"><?=str_repeat("&nbsp;&nbsp;&nbsp;&nbsp;",$v['level']-1).$v->name?></option>
                                  <?php endforeach;?>
                              </select>
                          </div>
                       </div>
