...
$modelLabel=new \backend\models\AdminCat();
?>
                    ...
                    <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                        ...
                        <div class="col-sm-12">
                            <table id="data_table" class="table" >
                                ...
                                <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" ><?=$modelLabel->getAttributeLabel("add_time")?></th>
                                ...
                                <?php foreach($model2 as $list):?>
                                    <tr <?=($list['level']!=1) ? 'style="display:none;"' : '';?>  id="<?=$list['level']-1?>_<?=$list['id']?>" class="<?=$list['level']-1?>">
                                      ...
                                      <!--  <td><?/*=$list['pid']*/?></td>-->
                                        <td><?=$list['level']?></td>
                                        <td><?=date('Y-m-d : H:i',$list['add_time'])?></td>
                                        <td class="center">
                            ...
                            <div style="display: none;">
                                <?php ActiveForm::begin(['id' => 'admin-module-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('content/index')]); ?>
