...
<div class="form-control" style="height: auto;min-height: 34px;"><?=$model->price?></div>   </div>
 ...
 <div class="clear"></div>
<div class="form-group">
   <label for="add_time" class="col-sm-2 control-label" ><?php echo $modelLabel->getAttributeLabel("add_time")?></label>
   <div class="col-sm-8">
<div class="form-control" style="height: auto;min-height: 34px;"><?=date('Y-m-d H:i',$model->add_time)?></div>   </div>
</div>
 <div class="clear"></div>
