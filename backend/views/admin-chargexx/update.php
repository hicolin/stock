                ...
                <div class="box-header">
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <a id="create_btn" href="<?=Url::toRoute('admin-chargexxes/index')?>" class="btn btn-xs btn-primary">admin-chargexxes列表</a>
                        </div>
                    </div>
                </div>
                <!-- /.box-header -->
...
<div class="form-group">
   ...
   <div class="col-sm-8">
   <?php echo $form->field($model,'pay_ordersid')->textInput(["class"=>"form-control","placeholder"=>$modelLabel->getAttributeLabel("pay_ordersid"),"id"=>'pay_ordersid']) ?>
   </div>
</div>
 <div class="clear"></div>
<div class="form-group">
