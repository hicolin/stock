            ...
            <div class="box">
                <div class="box-header">
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <a id="create_btn" href="<?= Url::toRoute('admin-chargexx/index') ?>"
                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-group">
                            <label for="money"
                                   class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("money") ?>/元</label>
                            <div class="col-sm-8">
                                <div class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="form-control"
                                     style="height: auto;min-height: 34px;"><?= $model->pay_type ?></div>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
                            <label for="title"
                                   class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("img_url") ?></label>
                            <div class="col-sm-8">
                                <div class="form-control" style="height: auto;min-height: 34px;"><img style="max-height: 100px;max-width: 120px;" src="<?= $model->img_url ?> "></div>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
