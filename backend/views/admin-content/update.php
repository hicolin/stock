...
<section class="content">
   ...
   <label for="title" class="col-sm-2 control-label" ><?php echo $modelLabel->getAttributeLabel("sortid")?></label>
   <div class="col-sm-8">
...
<div class="form-group">
   ...
   <div class="col-sm-8">
     <script id="container" name="contact" type="text/plain"><?= $model->contact;?></script>
   </div>
</div>
 <div class="clear"></div>
   ...
   <label for="img" class="col-sm-2 control-label" ><?php echo $modelLabel->getAttributeLabel("img")?></label>
     <div class="col-sm-8" id="site_img">
                                ...
                                if($model->img==null){
                                    ...
                                    echo '<img style="max-width:120px;height:80px" src="'.$model->img.'">';
                                }
                                ?><br>
                            </div>
                        </div>
...
<div class="form-group">
 ...
 <div class="clear"></div>
 <div class="form-group">
   <label for="top" class="col-sm-2 control-label" ><?php echo $modelLabel->getAttributeLabel("recommend")?></label>
   <div class="col-sm-8">
