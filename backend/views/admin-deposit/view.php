...
<div class="form-group">
   ...
   <div class="col-sm-8">
<div class="form-control" style="height: auto;min-height: 34px;"><?=$model->charge?></div>   </div>
</div>
 <div class="clear"></div>
<div class="form-group">
   <label for="time" class="col-sm-2 control-label" ><?php echo $modelLabel->getAttributeLabel("time")?></label>
   <div class="col-sm-8">
<div class="form-control" style="height: auto;min-height: 34px;"><?=$model->time?></div>   </div>
</div>
 <div class="clear"></div>
<div class="form-group">
