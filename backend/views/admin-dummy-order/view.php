                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="form-control"
                                     style="height: auto;min-height: 34px;"><?= $model->user_name ?></div>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="form-control"
                                     style="height: auto;min-height: 34px;"><?= $model->profit ?></div>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="add_time"
                                   class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("add_time") ?></label>
                            <div class="col-sm-8">
                                <div class="form-control"
                                     style="height: auto;min-height: 34px;"><?= date('Y-m-d',$model->add_time) ?></div>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="form-control"
                                     style="height: auto;min-height: 34px;"><?= date('Y-m-d',$model->update_time) ?></div>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
