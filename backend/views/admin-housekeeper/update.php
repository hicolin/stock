            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-group">
                            <label for="states"
                                   class="col-sm-2 control-label">代理商</label>
                            <div class="col-sm-8" style="padding-top: 8px;">
                                <?=$model->states==1?\backend\models\AdminUser::getName($model->agentid):'---' ?>
                                <?php /*echo $form->field($model, 'agentid')->dropDownList($agent, ['style' => 'width:120px']) */?>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8" >
                                <?php echo $form->field($model, 'account_id')->dropDownList($account, ['style' => 'width:120px']) ?>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <?php echo $form->field($model, 'states')->dropDownList(["0" => "可用", "1" => "不可用"], ['style' => 'width:120px']) ?>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
