                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                       ...
                       <!-- <div class="form-group">
                        ...
                        <div class="clear"></div>
                        <div class="form-group">
                            <label for="logdates" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("logdates") ?></label>
                            <div class="col-sm-8">
                                <div class="form-control" style="height: auto;min-height: 34px;"><?= date("Y-m-d H:i:s", $model->logdates) ?></div>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
                            <label for="logip" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("logip") ?></label>
                            <div class="col-sm-8">
                                <div class="form-control" style="height: auto;min-height: 34px;"><?= $model->logip ?></div>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
                            <label for="lognums" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("lognums") ?></label>
                            <div class="col-sm-8">
                                <div class="form-control" style="height: auto;min-height: 34px;"><?= $model->lognums ?></div>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
