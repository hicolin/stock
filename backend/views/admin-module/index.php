          	...
          	<div class="col-sm-12">
                ...
                <div class="col-lg-2 mar-10" style="margin-top: -8px">
                    <div class="input-group" style="margin: 5px;">
                        <span class="input-group-addon"><?=$modelLabel->getAttributeLabel('id')?>:</span>
                ...
                <div class="col-lg-2 mar-10" style="margin-top: -8px">
                    <div class="input-group" style="margin: 5px;">
                        <span class="input-group-addon"><?=$modelLabel->getAttributeLabel('code')?>:</span>
                ...
                <div class="col-lg-2 mar-10" style="margin-top: -8px">
                    <div class="input-group" style="margin: 5px;">
                        <span class="input-group-addon"><?=$modelLabel->getAttributeLabel('display_label')?>:</span>
