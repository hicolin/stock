                ...
                <div class="box-header">
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <a id="create_btn" href="<?=Url::toRoute('admin-orders/index')?>" class="btn btn-xs btn-primary">admin-orders列表</a>
                        </div>
                    </div>
                </div>
                <!-- /.box-header -->
...
<div class="clear"></div>
<div class="form-group">
   <label for="order_bl" class="col-sm-2 control-label" ><?php echo $modelLabel->getAttributeLabel("order_zy_money")?></label>
   <div class="col-sm-8">
...
<div class="clear"></div>
<div class="form-group">
   <label for="order_bl" class="col-sm-2 control-label" ><?php echo $modelLabel->getAttributeLabel("order_zs_money")?></label>
   <div class="col-sm-8">
...
<div class="clear"></div>
<div class="form-group">
   <label for="order_bl" class="col-sm-2 control-label" ><?php echo $modelLabel->getAttributeLabel("order_charge")?></label>
   <div class="col-sm-8">
...
<div class="clear"></div>
<div class="form-group">
   <label for="order_bl" class="col-sm-2 control-label" ><?php echo $modelLabel->getAttributeLabel("created_time")?></label>
   <div class="col-sm-8">
...
<div class="clear"></div>
<div class="form-group">
   <label for="order_bl" class="col-sm-2 control-label" ><?php echo $modelLabel->getAttributeLabel("status")?></label>
   <div class="col-sm-8">
   <?php echo $form->field($model,'status')->textInput(["class"=>"form-control","placeholder"=>$modelLabel->getAttributeLabel("status"),"id"=>'order_bl']) ?>
   </div>
</div>
