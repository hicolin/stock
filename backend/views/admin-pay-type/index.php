...
?>
                                <tr id="rowid_$list->id">
                                    <td><label><input type="checkbox" value="<?=$list->id?>"></label></td>
                                                                                <td><?=$list->id?></td>
                                                                                        <td><?=$list->pay_name?></td>
                                                                                        <td><?php echo AdminPayType::dropDownList('type',$list->type)?></td>
                                        ...
                                        <?php
                                            if ($list->status == 2) {
                                                echo "<a class='btn btn-danger btn-sm' href=" . Url::toRoute([$this->context->id . '/status', 'id' => $list->id]) . ">关闭</a>";
                                            } elseif ($list->status == 1) {
                                                echo "<a class='btn btn-primary  btn-sm' href=" . Url::toRoute([$this->context->id . '/status', 'id' => $list->id]) . ">开启</a>";
                                            } 
                                        ?>
                                            </td>                                             <!-- <td><?=$list->status?></td> -->
