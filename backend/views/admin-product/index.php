                ...
                <div class="box-header">
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <a id="create_btn" href="<?= Url::toRoute([$this->context->id . '/create', 'cid' => 1]) ?>"
                            ...
                            <div class="col-sm-12">
                                ...
                                <table id="data_table" class="table table-bordered table-striped dataTable" role="grid"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                            aria-sort="ascending"><?= $modelLabel->getAttributeLabel("code") ?></th>
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                        ...
                                        <tr id="rowid_$list->id">
                                            ...
                                            <td class="center">
                                                ...
                                                <a id="edit_btn" class="btn btn-primary btn-sm"
                                                   href="<?= Url::toRoute([$this->context->id . '/update', 'id' => $list->id, 'cid' => 1]) ?>">
