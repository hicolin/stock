                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="form-control" style="height: auto;min-height: 34px;"><?= $model->title ?></div>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="in_time"
                                   class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("in_time") ?></label>
                            <div class="col-sm-8">
                                <div class="form-control" style="height: auto;min-height: 34px;"><?= date('Y-m-d',$model->in_time) ?></div>
                            </div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="form-control" style="height: auto;min-height: 34px;"><?= $model->cat_id ?></div>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="form-group">
