    ...
    function updataAction(id,name,sort) {
        ...
        layer.open({
            ...
            yes:function () {
                ...
                $.post('<?= Url::to(['admin-stocks-category/update'])?>',{_csrf:_csrf,id:id,name:name,sort:sort},function (res) {
                    if(res.status === 200){
                        layer.closeAll();
    ...
    function createAction(){
        ...
        layer.open({
            ...
            yes:function () {
                ...
                $.post('<?= Url::to(['admin-stocks-category/create'])?>',{_csrf:_csrf,name:name,sort:sort},function (res) {
                    if(res.status === 200){
                        layer.closeAll();
                        layer.msg(res.msg,{icon:1,time:1500},function () {
                            location.reload();
