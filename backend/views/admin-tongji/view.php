                ...
                <div class="box-header">
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <a id="create_btn" href="<?= Url::toRoute('admin-tongji/index') ?>"
                        ...
                        foreach ($product as $key=> $val) {
                            if($model[$val]) { ?>
                                <div class="form-group">
                                    <label for="<?=$key?>"
                                           class="col-sm-2 control-label"><?= $val?></label>
                                    <div class="col-sm-8">
                                        <div class="form-control" style="height: auto;min-height: 34px;"><?= array_sum($model[$val]) ?></div>
                                    </div>
                                </div>
                                <div class="clear"></div>
                            <?php }
