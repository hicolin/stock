                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-2 mar-5">
                                        <div class="input-group" style="margin: 5px;">
                                            <span class="input-group-addon">返佣类型:</span>
                                            <select name="query[state]" class="form-control">
                                                <option value='-1'>请选择</option>
                                                <option value='1' <?=$query["state"]==1?'selected':''?>>综合返佣</option>
                                                <option value='2' <?=$query["state"]==2?'selected':''?>>递延返佣</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="input-group" style="margin: 5px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-primary btn-sm" href="<?= Url::toRoute([$this->context->id . '/commission-list']) ?>"> <i class="glyphicon glyphicon-zoom-in icon-white"></i>清空</a>
                                    </div>
                                    <?php ActiveForm::end(); ?>
                                </div>
                            </div>
                        ...
                        <!-- row end -->
                            ...
                            <div class="col-sm-12">
                                <div class="search col-sm-4">
                                    <button class="btn btn-success" style="border-right: none;float: left">总佣金/¥</button><span class="form-control" style="border-left: none;width: 140px;float: left"><?=$money['money']?></span>
                                </div>
                            </div>
                        </div>
    ...
    function deleteAction(id) {
        ...
        if (ids.length > 0) {
            admin_tool.confirm('请确认是否删除', function () {
                $.ajax({
                    type: "GET",
                    url: "<?=Url::toRoute($this->context->id . '/delrecord2')?>",
                    data: {"ids": ids},
                    cache: false,
                    dataType: "json",
                    error: function (xmlHttpRequest, textStatus, errorThrown) {
