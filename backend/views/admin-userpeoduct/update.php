                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="vatation_code2" id="vatation_code2" class="form-control" readonly placeholder="请输入被邀请码" value="<?=$invitation?>">
                            </div>
                        </div>
                        <div class="clear"></div>
                        <!--<div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-1">
                            ...
                            <div class="col-sm-1">
                                ...
                                <div class="span12 field-box">
                                    <input type="text" id="bank_address" class="form-control" name="AdminUserpeoduct[bank_address]" placeholder="开户行">
                                </div>
...
/*                                    echo $key%2!=0?'</div>':'';
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="submit" value="保存" id="sub" class="btn btn-primary" onclick="sub()" >
                                <span>&nbsp;</span>
...
<script>
    ...
    $("input[name='AdminUserpeoduct[uname]']").blur(function(){
        var uname = $(this).val();
        var _csrf =  $("input[name='_csrf']").val();
        // alert(_csrf);
        $.ajax({
            url  : "<?= Url::toRoute($this->context->id . '/validate-uname')?>",
            type : 'post',
            data : {'uname':uname,'_csrf':_csrf},
            dataType:'JSON',
            //beforeSend:function(){},
            success:function(data){
                if(data==300){
                    layer.tips('您输入的用户名已存在', "input[name='AdminUserpeoduct[uname]']", {tips:3,time:2000});
...
<script>
    function sub(){
        var uname = $('#uname').val();
        var vatation_code2 = $('#vatation_code2').val();
        // alert(uname);
        ...
        // return true;
        $.ajax({
            url  :"<?=Url::toRoute('admin-userpeoduct/update')?>",
            type : 'post',
            // data : {'uname':uname,'password':password,'id_card':id_card,'bank_name':bank_name,'bank_code':bank_code,'bank_province':bank_province,'bank_city':bank_city,'bank_address':bank_address,'license':license,'vatation_code':vatation_code,'uploadfile':uploadfile},
            dataType:'text',
            success:function(data){
                layer.tips(data, "#"+code, {tips:3,time:2000});
            }
        });
    }
</script>
