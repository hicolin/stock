...
class Excel {
     ...
     */
    public static function getExcelData($filePath, $startRow = 2, $is_time = [])
    {
        include_once dirname(__FILE__)."./../../vendor/phpoffice/phpexcel/Classes/PHPExcel.php";
        ...
        for ($i = 0; $i < $sheetCount; $i++) {
            ...
            for ($currentRow = $startRow; $currentRow <= $allRow; $currentRow++) {
                ...
                for ($currentColumn = 'A'; $currentColumn <= $allColumn; $currentColumn++) {
                    ...
                    if(in_array($currentColumn,$is_time)) {
     ...
     * @return bool
     */
    public static function createExcelFromData($fileds, $dataList = array(),$fileName = 'data.csv')
    {
        include dirname(__FILE__).'./../../vendor/phpoffice/phpexcel/Classes/PHPExcel.php';
