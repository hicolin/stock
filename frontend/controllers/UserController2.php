...

{
   ...
   public function actionOpt_ajax(){
      ...
      if($post){
        $weituo = $post['now'];
        $gushu = $money*8*(1-0.48/100)/$weituo;
        return $gushu;
      }
   }
...

    {
        ...
        if (Yii::$app->request->post()) {
            ...
            // $order_ly_money = Yii::$app->request->post('ly_money');

            // $order_bl = Yii::$app->request->post('ly_bl');

            // $order_zy_money = Yii::$app->request->post('zy_money');

            // $order_zs_money = Yii::$app->request->post('zs_money');

            // $order_charge = Yii::$app->request->post('jyMoney');
