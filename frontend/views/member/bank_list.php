            ...
            <div class="qhbox">
                <div class="menu menu0">
                    <ul class="style_head">
                        ...
                        <li><a href="<?=Url::toRoute(['member/recharge-record'])?>"  >充值记录</a></li>
                        <li><a href="<?=Url::toRoute(['member/bank-record'])?>" class="current">银行转账记录</a></li>
                    </ul>
                        ...
                        <table cellpadding="0" cellspacing="0" class="tab" id="ajaxGetRechargeList">
                            ...
                            foreach ($model as $list) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:aa('<?= $list->img_url ?>')"><img src = "<?= Url::base() ?>/backend/web/images/pictures.png">
                                            </a>
...
<div style="display: none;" id="tong">
    <img src = "" id = "tong1">
</div>
<script>
    function prompt(){
...
<script type="text/javascript">
    ...
    function aa(src) {
        ...
        tong1.src = src;
        tong1.style.width = "131px";
        tong1.style.height = "198px";
