            ...
            <div class="qhbox">
                <div class="menu menu0">
                    <ul class="style_head">
                        ...
                        <li><a href="<?=Url::toRoute(['member/withdraw-record'])?>" class="current">提款记录</a></li>
                ...
                <div class="cn style_content style_content0">
                    <div style="display:block;" class="ul" id="nav_cont1">
                        <!--<div class="frc-top" style="display: block;">
                            <form action="<?/*=Url::toRoute('member/withdraw-record')*/?>" method="get" style="margin-left: 6%;">
                                <span class="fl">日期：</span>
                                <input name="begin_time" id="b_time" type="text" class="fl date_picker" value="2018-04-25 00:00:00">
                                <img src="<?/*=Url::base()*/?>/frontend/web/img/rl.png" class="fl"/>
                                <i class="fl"></i>
                                <input name="end_time"  id="e_time" type="text" class="fl date_picker"  value="2018-04-26 00:00:00">
                                <img src="<?/*=Url::base()*/?>/frontend/web/img/rl.png" class="fl"/>

                                <input type="hidden" name="r" value="member/withdraw-record">
