        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status == '00') {
                    ...
                    $('.new_price').html(Math.floor(data.new_price * 10) / 10);
                    ...
                    $('.minimum_price').html(Math.floor(data.minimum_price * 100) / 100);
                    $('.highest_price').html(Math.floor(data.highest_price * 100) / 100);
                    $('.opening_price').html(Math.floor(data.opening_price * 100) / 100);
                    $('.volume').html((data.volume/100000000).toFixed(2) + '亿');
                    $('.turnover').html((data.turnover/100000000).toFixed(2) + '亿');
                    $('.upstop').html((data.settlement_yesterday * (1 + 10 / 100)).toFixed(2));
                    $('.downstop').html((data.settlement_yesterday * (1 - 10 / 100)).toFixed(2));
